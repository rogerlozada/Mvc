...
namespace Microsoft.AspNetCore.Mvc
{
    ...
    public class UnprocessableEntityObjectResult : ObjectResult
    {
        ...
        public UnprocessableEntityObjectResult([ObjectResultValue] ModelStateDictionary modelState)
        ...
        public UnprocessableEntityObjectResult([ObjectResultValue] object error)
            : base(error)
        {
